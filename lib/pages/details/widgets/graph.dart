...
class GraphPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    ..color = const ui.Color.fromARGB(255, 253, 154, 5)
    ...
    ..strokeWidth = 3.0;
     ...
     ..shader = ui.Gradient.linear(
      ...
      [
        const ui.Color.fromARGB(255, 249, 142, 1),
        Colors.white,
      ],
     )
    ..color = const ui.Color.fromARGB(255, 249, 120, 28)
    ..style = PaintingStyle.fill;

    Paint dotOutlinePaint = Paint()..color = Colors.white.withAlpha(200)
    ..strokeWidth = 8;

    Paint dotCenter = Paint()..color = const ui.Color.fromARGB(255, 248, 118, 4)
    ..strokeWidth = 8;
